...
urlpatterns = [
    ...
    path('feed_dashboard_view/<int:user_id>/',views.feed_dashboard_view, name='feed_dashboard_view'),
    ...
    path('renew-certificate/<int:user_id>/', renew_pollution_certificate, name='renew_certificate'),
    path('add_daily_data',views.add_daily_data, name='add_daily_data'),
    path('batch/<int:batch_id>/daily-data/', views.list_daily_data, name='list_daily_data'),
    path('edit_daily_data/<int:id>/', views.edit_daily_data, name='edit_daily_data'),
    path('delete-entry/<int:daily_data_id>/', views.delete_daily_data, name='delete_daily_data'),
    ...
    path('edit_supplier/<int:supplier_id>/',edit_supplier, name='edit_supplier'),  # Ensure the URL accepts an ID
