...
from .views import (
    ...
    cart_view, update_cart, checkout_view, wallet_view, add_funds_to_wallet,buy_entire_batch, track_order
...
urlpatterns = [
    ...
    path('track-order/<int:order_id>/<str:token>/', track_order, name='track_order'),
